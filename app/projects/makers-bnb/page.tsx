                ...
                <div className="mx-auto max-w-5xl px-4">
                        ...
                        <aside className="space-y-4 rounded-2xl border border-white/10 bg-[#090B1C] p-5 text-xs text-white/80">
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    ...
                                    Designed booking availability checks and conflict detection
                                    queries before booking requests were persisted.
                                </li>
                            </ul>
                        </aside>
                    </section>
                    ...
                    <section className="mt-10 rounded-2xl border border-white/10 bg-[#090B1C] p-5 text-sm text-white/80">
                        ...
                        <p className="mt-3 leading-relaxed">
                            One challenge was handling overlapping date requests reliably under
                            time pressure. I solved it by validating booking windows in
                            repository queries before writes, which reduced booking clashes and
                            made request outcomes deterministic.
                        </p>
                    </section>
